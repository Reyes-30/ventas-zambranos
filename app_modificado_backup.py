...
Autor: Estudiante de Ingeniería Informática
Materia: Ciencias de Datos II
...
st.set_page_config(
    ...
    menu_items={
        ...
        **🚀 Características Avanzadas:**
        - 🎨 Sistema de temas dinámicos profesionales
        - 📊 Análisis exploratorio automático con IA
        - 🎯 Visualizaciones interactivas de alto impacto
        - 🤖 Machine Learning integrado y comparación de modelos
        - 📈 Dashboard ejecutivo con métricas en tiempo real
...
# 🏗️ INICIALIZACIÓN DE ESTADOS DE SESIÓN
def initialize_session_state():
    """Inicializa todos los estados de sesión necesarios"""
    session_defaults = {
        'selected_theme': 'claro',
        'processed_data': None,
        'authenticated': False,
...
# CSS personalizado para mejorar la interfaz y sistema de temas dinámicos
def load_custom_css(theme="claro"):
    """
    Carga CSS personalizado con sistema de temas profesional.
    ...
    themes = {
        ...
        "oscuro": {
            ...
            "gradient_primary": "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
            "gradient_secondary": "linear-gradient(90deg, #2d2d2d 0%, #404040 100%)"
        },
        "academico": {
            "bg_primary": "#fefefe",
            "bg_secondary": "#f5f5f5",
        ...
        "presentacion": {
            ...
            "gradient_primary": "linear-gradient(135deg, #00d4aa 0%, #667eea 100%)",
            "gradient_secondary": "linear-gradient(90deg, #1e2328 0%, #2d3748 100%)"
        }
    }
    ...
    /* Ocultar elementos no relevantes de Streamlit */
    ...
    /* Elementos específicos para tema oscuro */
    {'''
    ...
    ''' if theme == "oscuro" or theme == "presentacion" else ''}
    ...
    * {{
    ...
    /* Tema presentación: efectos especiales */
    {'''
    .main-header {
